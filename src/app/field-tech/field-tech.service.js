...
var FieldTechService = (function () {
    function FieldTechService(http, processorService, messageService) {
        this.http = http;
        this.processorService = processorService;
        this.messageService = messageService;
        this.fieldTechs = [];
        this.url = '/api/FieldTechs';
    }
    FieldTechService.prototype.getTechs = function () {
...
FieldTechService = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_1.Http,
        processor_service_1.ProcessorService, message_service_1.MessageService])
], FieldTechService);
exports.FieldTechService = FieldTechService;
//# sourceMappingURL=field-tech.service.js.map